<template>
  <div class="quality bg-grey-lighten-2 py-13">
    <v-container fluid>
      <v-row>
        <v-col
          :clos="12"
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              class="text-center d-flex align-center justify-space-between px-5"
              height="300"
              v-bind="props"
            ...
            >
              <div class="parent">
                ...
                >
                <v-card-text>{{ card.dec }}</v-card-text>
              </div>
            </v-card>
          </v-hover>
        </v-col>
