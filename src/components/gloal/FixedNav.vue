<template>
  <div class="fixed-nav">
    <v-app-bar color="#0a4f99">
      <v-container fluid>
        <v-row>
          <v-col :cols="2">
            <img
              class="w-50"
              src="@/assets/images/Elaraby-group-logo.png"
              alt=""
          ...
          <v-col :cols="7">
            <ul
              class="links d-flex text-center justify-space-between"
          ...
          >
            ...
            <div
              class="wishlists d-flex align-center flex-column align-center"
