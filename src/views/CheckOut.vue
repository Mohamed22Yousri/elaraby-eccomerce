      ...
      <v-row>
        <v-col :cols="12" md="6" lg="7" class="order-1 order-md-0">
          <v-card
            ...
            elevation="0"
            class="check-out-left w-100"
          >
            <v-card-title class="font-weight-bold"
              >new-elaraby-demo</v-card-title
            >
            <v-breadcrumbs
              :items="['Car', 'Information']"
            ...
            <v-card-actions
              class="d-flex aling-center justify-space-between mb-7"
            >
              <v-btn
                color="#5a48d3"
                variant="elevated"
            ...
            <v-card-title>Shipping Addresses</v-card-title>
            <select
              class="w-100 pa-3"
              name=""
              id=""
              style="border: 1px solid #ffb8b8; border-radius: 3px"
            >
              <option
            ...
            <v-card-actions class="d-flex justify-end my-7">
              <v-btn
                @click="dialog = true"
                variant="elevated"
                height="45"
            ...
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text style="font-size: 12px; color: #777777"
              >All Rights Reserved new-elaraby-demo
            </v-card-text>
            <v-divider length="100%" color="black"></v-divider>
            <v-divider length="100%" color="black"></v-divider>
          </v-card>
        ...
        <v-col :cols="12" md="6" lg="5" class="py-0">
          ...
          >
            ...
            >
              <v-badge :content="item.quantity" color="grey-darken-1">
                <img
                  ...
                  width="50"
                  height="50"
                  style="border-radius: 7px; border: 1px solid #cfcfcf"
                />
              </v-badge>
              <div class="title-parent flex-grow-1">
                ...
                >
                <v-card-text
                  style="white-space: pre-wrap; font-size: 11px; color: #777777"
            ...
            <v-card-text
              ...
              ><span class="px-0">Total</span>${{ CalcTotalPrice }} <span></span
            ></v-card-text>
          </v-card>
        </v-col>
      </v-row>
...
import OrderSuccessVue from "@/components/order-success/OrderSuccess.vue";
export default {
  components: {
    OrderSuccessVue,
  },
